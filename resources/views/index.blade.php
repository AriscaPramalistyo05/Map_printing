                ...
                <div id="costum_slider" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            ...
                            <p class="there_text">There are many variations of passages of Lorem Ipsum available, but
                                the majority have suffered alteration in some fo</p>
        ...
        <div class="container">
            ...
            <div class="services_section2 layout_padding">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="icon_1"><img src="{{ asset('assets/images/icon-2.pn') }}g"></div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="icon_1"><img src="{{ asset('assets/images/icon-3.pn') }}g"></div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="icon_1"><img src="{{ asset('assets/images/icon-4.pn') }}g"></div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="container_main1">
                                            <img src="{{ asset('assets/images/img-4.png') }}" alt="Avatar" class="image"
                                                style="width:100%">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="container_main1">
                                            <img src="{{ asset('assets/images/img-5.png') }}" alt="Avatar" class="image"
                                                style="width:100%">
                                            <h1 class="modern_text">Modern home designe</h1>
                                            <div class="middle">
                                                <div class="text">VIEW MORE</div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="container_main1">
                                            <img src="{{ asset('assets/images/img-6.png') }}" alt="Avatar" class="image"
                                                style="width:100%">
                                            <h1 class="modern_text">Modern home designe</h1>
                                            <div class="middle">
                                                <div class="text">VIEW MORE</div>
                            ...
                            <div class="client_1">
                                <div class="row">
                                    <div class="col-sm-3">
                                        ...
                                        <div class="quote_icon"><img src="{{ asset('assets/images/quote-icon.png') }}"></div>
                                    </div>
                                    <div class="col-sm-9">
